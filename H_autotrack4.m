function res=H_autotrack4(cod, maxdist, mod)
%CopyRight Hiroshi Ujii
% This function connect tracks of single parting within a cirtein distance
%
%Input:
%cod is coordinates of tracks with frame number
%maxdist is maximum distance between tracks to be connected
%mod is mode of connection. mod==1; does not connect tracks when more than
...
%
%Format
%     (frame)   (x)    (y) (any other information)
%cod=[1 258.5	135.17
%   1   287.27	162.1
%   1   187.56	356.22
%   1   279.98	290.76
...
%   4   233.25	321.75	];
%
%      (x)     (y)   (frame) (# trajectry) (any other information)
...
% function index=getcodpos(MM,trnr)
% index=MM(:,1); index(index(:)==0)=[];
% end
